...
java -Djava.security.properties="./config/java.security" -Dlogback.configurationFile="./config/logback.xml" -classpath "build/install/library/lib/*"  bftsmart.demo.counter.CounterClient 1001 100 8
